...
model = Qwen2_5_VLForConditionalGeneration.from_pretrained("./Qwen/Qwen2.5-VL-7B-Instruct/", device_map="auto", torch_dtype=torch.bfloat16, trust_remote_code=True,)
...
swanlab_callback = SwanLabCallback(
    ...
    experiment_name="qwen2_5-vl-coco2014-5000",
    config={
...
# 获取测试模型
val_peft_model = PeftModel.from_pretrained(model, model_id="./output/Qwen2_5-VL-7B/checkpoint-930", config=val_config)
